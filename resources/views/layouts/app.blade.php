...
<head>
    ...
    <title>100M Sprint Leaderboard</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="app-navbar-collapse">
                ...
                <ul class="nav navbar-nav">
                                @if (Auth::guest())
                                @else
                                    <li><a href="{{ url('/runners') }}"><i class="fa fa-users" aria-hidden="true"></i> Runners</a></li>
                                    <li><a href="{{ url('/create') }}"><i class="fa fa-user-plus" aria-hidden="true"></i> Create </a></li>
                                @endif
                </ul>
